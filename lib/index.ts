...
export class AntMessenger extends AntApi {
    ...
    public add(type: 'sticker', status: string, listener: (id: string, sticker: T.StickerPayload) => any): void;
    public add(type: 'image', status: string, listener: (id: string, image: T.ImagePayload) => any): void;
    public add(type: 'audio', status: string, listener: (id: string, audio: T.AudioPayload) => any): void;
    public add(type: 'location', status: string, listener: (id: string, location: T.LocationPayload) => any): void;
    public add(type: 'postback', status: string, listener: (id: string, payload: string) => any): void;
